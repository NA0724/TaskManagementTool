...
import com.tmt.TaskManagementTool.exceptions.SpringException;
...
public class JwtTokenProvider {
    ...
    private static final String AUTH_STORE = "task-management";
    ...
    public void loadKeyStore() {
        try {
            ...
            throw new SpringException("Exception occured while loading keystore");
        }
    ...
    private PrivateKey getPrivateKey() {
        try {
            ...
            throw new SpringException("Exception occurred while retrieving public key from keystore");
        }
    }
